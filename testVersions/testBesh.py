...
def main():
    ...
    bg = pygame.transform.scale(pygame.image.load("images/kids.png"), (1400,800))
    girl_still = pygame.transform.scale(pygame.image.load("images/default.png"), (300, 300))
    red = (255, 0, 0)
    red_surface = pygame.Surface((80, 80))  # Create a surface with the desired dimensions
    red_surface.blit(girl_still, (0,0))
    ...
    class Girl(pygame.sprite.Sprite):
        def __init__(self):
            ...
            self.rect = pygame.Rect(0, 0, 80, 200)
    ...
    all_sprites.add(green_cube, blue_cube, dastarkhan, girl)
